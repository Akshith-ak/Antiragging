        ...
        <div className="report-incident-page">
            <header className="header">
                ...
                <nav className="header-nav">
                    ...
                    <NavLink to="/report" className="nav-link active"><FaFileAlt /> Report Incident</NavLink>
            ...
            <div className="report-container">
                ...
                <form className="report-form" onSubmit={handleSubmit}>
                    <div className="form-section">
                        ...
                        <textarea className="form-textarea" placeholder="Describe the incident..." value={description} onChange={(e) => setDescription(e.target.value)} required />
                        <p className="form-help-text">Minimum 50 characters required.</p>
                    </div>
                    <div className="form-row">
                        <div className="form-group"><label className="form-label"><FaCalendarAlt /> Incident Date</label><input type="date" className="form-input" value={date} onChange={(e) => setDate(e.target.value)} /></div>
                        <div className="form-group"><label className="form-label"><FaClock /> Approximate Time</label><input type="time" className="form-input" value={time} onChange={(e) => setTime(e.target.value)} /></div>
                    </div>
                    ...
                    <div className="privacy-notice">
                        ...
                        <div><h4>Your Privacy is Protected</h4><p>This form does not collect any identifying information.</p></div>
                    </div>
